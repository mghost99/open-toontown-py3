...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.estatesDisabled = DirectButton(
            parent=self.map,
            relief=None,
            ...
            text_pos=(0, -0.02),
            textMayChange=0,
            command=self.__handleNoEstateDialogWithConfirm)
    ...
    def enter(self):
        ...
        if base.cr.playGame.getPlaceId() == ToontownGlobals.MyEstate and base.cr.playGame.hood.loader.atMyEstate() or self.book.safeMode:
            ...
            if base.cr.estateMgr:
                self.goHomeButton.show()
            else:
                self.estateDisabled.show()
    ...
    def __handleNoEstateDialogWithConfirm(self):
        self.dialogBox = TTDialog.TTDialog(style=TTDialog.Acknowledge, text=TTLocalizer.MapPageEstatesDisabled, text_wordwrap=15, command=self.__acceptExit)
        self.dialogBox.show()
        base.localAvatar.startSleepWatch(self.__acceptExit)
